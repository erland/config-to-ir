...
/**
 * Zod schemas describing the tool configuration.
 *
 * Note: The repo historically kept schemas + inferred types in a single file.
 * This file now contains only schemas; inferred types live in `model.ts`.
 */
...
/**
 * Extraction primitives supported by the entity rule engine.
 */
...
/**
 * Relationship rules (fact-graph relations)
 */
